console.log("[COLLABORATION] Module loading started");
import {pub} from "@benev/slate"
console.log("[COLLABORATION] @benev/slate imported");
import Sparrow, {Connection, SparrowHost, Join} from "sparrow-rtc"
console.log("[COLLABORATION] sparrow-rtc imported");

import {Actions} from "../../../state/actions"
console.log("[COLLABORATION] Actions imported");
import {omnislate} from "../../../omnislate"
console.log("[COLLABORATION] omnislate imported");
import {Compressor} from "./parts/compressor"
console.log("[COLLABORATION] Compressor imported");
import {FileHandler} from "./parts/file-handler"
console.log("[COLLABORATION] FileHandler imported");
import {OPFSManager} from "./parts/opfs-manager"
console.log("[COLLABORATION] OPFSManager imported");
import {showToast} from "../../../utils/utils/show-toast"
console.log("[COLLABORATION] showToast imported");
import {MessageHandler} from "./parts/message-handler"
console.log("[COLLABORATION] MessageHandler imported");
import {AnyMedia} from "../../../types/media-types"
console.log("[COLLABORATION] All imports complete");

export class Collaboration {
	host: SparrowHost | null = null
	client: Join | null = null
